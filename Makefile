...
cask-apps: brew
	...
	for EXT in $$(cat install/Codefile); do devin --install-extension $$EXT --force; done
	echo "Installing VS Codium extensions from source..."
	for EXT in $$(ls install/vscode/extensions); do devin --install-extension install/vscode/extensions/$$EXT --force; done
